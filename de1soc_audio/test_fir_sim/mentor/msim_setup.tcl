...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/test_fir_rtl_core.vhd"                          
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/test_fir_ast.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/test_fir.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/test_fir_tb.vhd"                                
}
