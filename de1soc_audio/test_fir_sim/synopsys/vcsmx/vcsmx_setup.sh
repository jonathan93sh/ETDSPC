...
# ACDS 16.1 196 win32 2017.02.17.15:19:20
...
# ----------------------------------------
# If test_fir is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/test_fir_rtl_core.vhd"                          
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/test_fir_ast.vhd"                               
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/test_fir.vhd"                                   
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/test_fir_tb.vhd"                                
fi
